...
import CBA.data.jpa.SampleDataJpaApplication;
import CBA.data.jpa.domain.City;
import CBA.data.jpa.domain.Hotel;
import CBA.data.jpa.domain.HotelSummary;
import CBA.data.jpa.domain.Rating;
import CBA.data.jpa.domain.RatingCount;
